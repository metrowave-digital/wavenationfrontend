...
const page = marketingPages.contributorsApply

const route = '/contributors/apply'
...
const socialImage = {
  ...
  width: 1200,
  height: 630,
  alt: 'Apply as a WaveNation contributor',
}
...
const contributorsApplyJsonLd = {
  ...
  mainEntity: {
    ...
    potentialAction: {
      '@type': 'ApplyAction',
      name: 'Apply as a WaveNation contributor',
      target: pageUrl,
    },
  },
}
...
export const metadata: Metadata = {
  ...
  keywords: [
    'WaveNation contributors',
    'apply as contributor',
    'WaveNation writer application',
    'culture writer application',
    'music contributor application',
    'media contributor application',
    'entertainment contributor',
    'Black media contributors',
    'creator contributor application',
  ...
  category: 'Contributor Applications',
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: route,
...
export default function ContributorsApplyPage() {
  return (
    <main
      data-analytics-page="contributors-apply"
      data-analytics-page-title={page.title}
      data-analytics-page-type="marketing-lead"
      data-analytics-funnel="contributors"
      data-analytics-conversion="marketing-inquiry"
    >
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: serializeJsonLd(contributorsApplyJsonLd),
        }}
      />
