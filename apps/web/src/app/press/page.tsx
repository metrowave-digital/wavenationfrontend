...
const page = marketingPages.press
...
const socialImage = {
  ...
  width: 1200,
  height: 630,
  alt: 'WaveNation press and media requests',
}
...
const pressJsonLd = {
  ...
  mainEntity: {
    ...
    url: siteBaseUrl,
    description:
      'WaveNation Media is a digital radio, streaming, culture, events, and creator-focused media platform.',
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'press and media inquiries',
      url: pageUrl,
      areaServed: 'US',
    ...
    potentialAction: {
      ...
      name: 'Submit a press or media request',
      target: pageUrl,
    },
  },
}
...
export const metadata: Metadata = {
  ...
  keywords: [
    'WaveNation press',
    'WaveNation media requests',
    'WaveNation press inquiries',
    'WaveNation media kit request',
    'press contact',
    'media contact',
    'interview requests',
    'brand inquiries',
