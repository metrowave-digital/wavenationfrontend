...
import { filterShows, getFilterLinks, getPodcasts } from '@/lib/wavenation-shows'
...
export const metadata: Metadata = {
  ...
  description: 'Browse WaveNation podcasts, on-demand conversations, culture shows, and storytelling series.',
}
...
export default async function PodcastsPage({ searchParams }: PageProps) {
  ...
  const filterValues = podcasts.flatMap((show) => [...(show.categories || []), show.formatLabel || '']).filter(Boolean)
  ...
  return (
    <main className={styles.page}>
      <ShowsDirectory
        ...
        filters={getFilterLinks('/shows/podcasts', 'All Podcasts', filterValues, activeFilter)}
