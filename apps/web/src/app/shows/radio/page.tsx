...
import { filterShows, getFilterLinks, getRadioShows } from '@/lib/wavenation-shows'
...
export const metadata: Metadata = {
  ...
  description: 'Browse active WaveNation FM radio shows, syndicated programs, DJs, and specialty blocks.',
}
...
export default async function RadioShowsPage({ searchParams }: PageProps) {
  ...
  const filterValues = shows.flatMap((show) => [...(show.genres || []), show.formatLabel || '']).filter(Boolean)
  ...
  return (
    <main className={styles.page}>
      <ShowsDirectory
        ...
        shows={filteredShows}
        filters={getFilterLinks('/shows/radio', 'All Radio', filterValues, activeFilter)}
