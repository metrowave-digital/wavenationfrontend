...
export const metadata: Metadata = {
  ...
  title: 'Terms of Service | WaveNation',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'WaveNation Terms of Service',
      },
    ],
  },
  twitter: {
...
export default function TermsPage() {
  return (
    <div
      data-analytics-page="terms"
      data-analytics-page-title="Terms of Service"
